    ...
    <td align="center"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          ...
          <td width="433" align="center">
			...
			%>
			<!--
          <span class=blue>전체보기</span>&nbsp;I &nbsp;<a href="#" class=area>수도권</a>&nbsp;I &nbsp;<a href="#" class=area>강원권</a>&nbsp;I &nbsp;<a href="#" class=area>충청권</a>&nbsp;I &nbsp;<a href="#" class=area>전라권</a>&nbsp;I &nbsp;<a href="#" class=area>경상권</a>&nbsp;I &nbsp;<a href="#" class=area>제주도</a>
          -->
          </td>
  ...
  <tr>
    <td><table border="0" cellpadding="2" cellspacing="1" width="100%" bgcolor="#D1D3D4">
        ...
        <%
			...
			%>
			<TR height="30">
			<td height="30" bgcolor="white" style="padding-left:5px;"><span class=blue_list><a href="detail_pre.jsp">골프장명</a></span></td>
			<%
			incDate.set(tYear, tMonth-1, tDay);
			for (int k = 1; k < 15 ;k++){
