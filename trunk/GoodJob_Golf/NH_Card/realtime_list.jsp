    ...
    <tr>
        <td align="center">
          ...
          <td width="433" align="center">
			...
			<%}else{%>
			<a class=area href="realtime_list.jsp?date=<%=strDate %>">전체보기</a>&nbsp;I&nbsp;
			<%}
			...
			<%}else{%>
			<A class=area href="realtime_list.jsp?region=<%=rList.get(i).getRegion_seq()%>&date=<%=strDate %>"><%=rList.get(i).getRegion_name()%></A> <%=i+1 < rList.size()? "&nbsp;I&nbsp;":"" %>
			<%
				}
			}
			%>
          ...
          <td width="19%" align="right"><table border="0" cellpadding="0" cellspacing="0" width="140">
              <tr>
                <td width="70" align="center"><a href="./realtime_list.jsp?menu=<%=menuNum%>&region=<%=pRegion %>&date=<%=preDate%>"><img align="absmiddle" src="../images/booking/btn_2week_pre.gif" width="62" height="22" border="0"></a></td>
                <td width="70" align="right"><a href="./realtime_list.jsp?menu=<%=menuNum%>&region=<%=pRegion %>&date=<%=eDate%>"><img align="absmiddle" src="../images/booking/btn_2week_later.gif" width="62" height="22" border="0"></a></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
