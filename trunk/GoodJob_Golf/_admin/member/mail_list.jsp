  ...
  <tr>
    <td align="center" style="padding-top:50px;padding-bottom:40px;"><table border="0" cellpadding="0" cellspacing="0" width="70%">
        <tr>
          ...
          <td width="50%" align="center"><a href="mail_pop.jsp" onClick="NewWindow(this.href,'name','740','600','yes');return false"><img src="/_admin/images/inc/btn_mail_send.gif" width="200" height="39" border="0"></a></td>
        </tr>
      </table></td>
  </tr>
</table>
