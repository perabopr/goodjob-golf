...
if(request.getParameterValues("pdsubseq") != null 		
	...
	String arrSHour[] = request.getParameterValues("course_S_hour");
	String arrSMin[] = request.getParameterValues("course_S_minute");	
	String arrEHour[] = request.getParameterValues("course_E_hour");
	...
	for(int i = 0; i < arrPrdtSubSeq.length;i++){
		...
		pdsd2.setTime_start(arrSHour[i]+arrSMin[i]);
		pdsd2.setTime_end(arrEHour[i]+arrEMin[i]);
