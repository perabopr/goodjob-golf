...
<%@ page import="com.goodjob.product.dto.*" %>
...
<%
	...
	/*
	String[] priceN1 = fileUpload.getParameterValues("priceN1");
	String[] priceN2 = fileUpload.getParameterValues("priceN2");
	String[] priceS1 = fileUpload.getParameterValues("priceS1");
	String[] priceS2 = fileUpload.getParameterValues("priceS2");
	String[] priceS3 = fileUpload.getParameterValues("priceS3");
	String[] priceS4 = fileUpload.getParameterValues("priceS4");
	*/
	int ii = 1;
	for(int i = 1; i <= 2;i++){
