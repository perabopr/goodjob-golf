...
<%
	...
	if(name == null) name = StringUtils.defaultString((String)session.getAttribute("mem_name"),""); 
                                                        ...
                                                        <tr>
                                                          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                              <tr>
                                                                ...
                                                                <td width="26">&nbsp;</td>
                                                                <td width="110" class=blue><input class="input_01" id="join_name" name="join_name" type="text" size="20" value="<%=name%>"/></td>
