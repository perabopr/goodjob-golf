                                  ...
                                  <td width="751"><table border="0" cellpadding="2" cellspacing="1" width="751" bgcolor="#D2D2D2">
                                      <tr>
                                        <td align="center" bgcolor="white" width="745" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="95%">
                                            <tr>
                                              <td align="right" class="location" height="30" width="95%"><a href="/">HOME</a> &gt; <span class=location_b>개인정보취급방침</span></td>
                                            </tr>
                                            <tr>
                                              <td bgcolor="#D1D3D4" height="33" class="sub_title" style="padding-left:15px;padding-top:4px">개인정보취급방침</td>
                                            </tr>
                                            <tr>
                                              <td valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                  ...
                                                  <tr>
                                                    <td style="padding-left:10px;padding-right:10px;">'(주)세이브코리아(Good Job Golf)' 은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, &quot;정보통신망 이용촉진 및 정보보호&quot;에 관한 법률을 준수하고 있습니다.<br>
                                                      <br>
                                                      ...
                                                      <br>
                                                      *본 방침은 &nbsp;: &nbsp;2012 년 01 월 02 일 부터 시행됩니다.<br>
                                                      <br>
                                                      <span class=blue>■ 수집하는 개인정보 항목</span><br>
                                                      회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br>
                                                      <br>
                                                      *수집항목 : 회원명(실명) ,아이디(E-Mail) ,비밀번호 ,핸드폰 ,신용카드 정보 ,은행계좌 정보 ,서비스 이용기록 ,접속 로그 ,쿠키 ,접속 IP 정보 ,결제기록 ,법정대리인 이름<br>
                                                      *개인정보 수집방법 : 홈페이지(www.goodjobgolf.com) , 경품 행사 응모<br>
                                                      <br>
                                                      <span class=blue>■ 개인정보의 수집 및 이용목적</span><br>
                                                      회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.<br>
                                                      <br>
                                                      *서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산<br>
                                                      콘텐츠 제공 ,구매, 요금 결제 ,물품배송, 청구지 등 발송 ,금융거래 본인 인증 및 금융 서비스<br>
                                                      <br>
                                                      *회원 관리<br>
                                                      ...
                                                      *마케팅 및 광고에 활용<br>
                                                      ...
                                                      <br>
                                                      <span class=blue>■ 개인정보의 보유 및 이용기간</span><br>
                                                      ...
                                                      <br>
                                                      보존 항목 : 회원명(실명) ,아이디(E-Mail), 비밀번호, 핸드폰<br>
                                                      ...
                                                      <br>
                                                      <span class=blue>■ 개인정보의 파기절차 및 방법</span><br>
                                                      ...
                                                      *파기절차<br>
                                                      ...
                                                      <br>
                                                      별도 DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 보유 되어지는 이외의 다른 목적으로 이용되지 않습니다.<br>
                                                      <br>
                                                      *파기방법<br>
                                                      전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다. <br>
                                                      <br>
                                                      <span class=blue>■ 개인정보 제공</span><br>
                                                      회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.<br>
                                                      <br>
                                                      - 이용자들이 사전에 동의한 경우<br>
                                                      - 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우<br>
                                                      <br>
                                                      <span class=blue>■ 수집한 개인정보의 위탁</span><br>
                                                      회사는 고객님의 동의 없이 고객님의 정보를 외부 업체에 위탁하지 않습니다. 향후 그러한 필요가 생길 경우, 위탁 대상자와 위탁 업무 내용에 대해 고객님에게 통지하고 필요한 경우 사전 동의를 받도록 하겠습니다.<br>
                                                      <br>
                                                      <span class=blue>■ 이용자 및 법정대리인의 권리와 그 행사방법</span><br>
                                                      ...
                                                      <br>
                                                      <span class=blue>■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</span><br>
                                                      ...
                                                      <br>
                                                      <span class=blue>▶ 쿠키 등 사용 목적</span><br>
                                                      ...
                                                      <br>
                                                      <span class=blue>▶ 쿠키 설정 거부 방법</span><br>
                                                      ...
                                                      <br>
                                                      <span class=blue>■ 개인정보에 관한 민원서비스</span><br>
                                                      회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보관리책임자를 지정하고 있습니다.<br>
                                                      <br>
                                                      *고객서비스담당 부서 : 관리팀<br>
                                                      *전화번호 : 02-6670-0216<br>
                                                      *이메일 : ksjung@savekorea.com<br>
                                                      *개인정보관리책임자 성명 : 조길구 과장<br>
                                                      *전화번호 : 02-6670-0205<br>
                                                      *이메일 : periwinkle@savekorea.com<br>
                                                      <br>
                                                      ...
                                                      4.경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)</td>
                                                  </tr>
                                                  <tr>
                                                    <td align="center">&nbsp;</td>
                                                  </tr>
