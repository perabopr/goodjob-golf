...
DROP TABLE IF EXISTS tb_notice_bbs;
DROP TABLE IF EXISTS tb_faq_bbs;
...
CREATE TABLE TB_GOLFLINK_PROMISE(
		golflink_seq                  		INT		 NOT NULL,
		promise1_type                 		TEXT		 NULL ,
		promise1                      		TEXT		 NULL ,
		promise2_type                 		TEXT		 NULL ,
		promise2                      		TEXT		 NULL ,
		promise3_type                 		TEXT		 NULL ,
		promise3                      		TEXT		 NULL ,
		promise4_type                 		TEXT		 NULL ,
		promise4                      		TEXT		 NULL ,
		promise5_type                 		TEXT		 NULL ,
		promise5                      		TEXT		 NULL ,
...
CREATE TABLE tb_join_bbs(
		join_seq                      		INT(11)		 NOT NULL AUTO_INCREMENT PRIMARY KEY,
		mem_id                        		VARCHAR(100)		 NOT NULL,
...
CREATE TABLE tb_join_comment(
		cmt_seq                       		INT(11)		 NOT NULL AUTO_INCREMENT PRIMARY KEY,
