...
<!-- 상단 영역 -->
					...
					<table border="0" cellpadding="0" cellspacing="0" width="751">
                                        ...
                                        <td align="center" bgcolor="white" width="745" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="95%">
                                            ...
                                            <tr>
                                              <td valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                  ...
                                                  <tr>
                                                    <td align="center">
                                                     <img src="../../images/common/img_member_event.jpg" width="707" height="643" border="0" usemap="#ImageMap1"></td>
                                                  </tr>
                                                  <tr>
                                                   <td>&nbsp;</td>
                                                  </tr>
                        ...
                        <map name="ImageMap1">
<area shape="rect" coords="241, 458, 443, 520" href="/member/join_agreement.jsp">
</map>
					<!-- 하단  회사 소개 부분  -->
