...
if(strDate == null || strDate.length() != 8){
	out.print("<script>");
	out.print("location.href='/forGolfbooking/reserveRealPre.jsp?menu=12&region="+pRegion+"&date="+strDate+"';");
	out.print("</script>");
	return;
	/*
...
String strWhere = "AND C.site_seq = 1 AND C.menu_seq = 1 AND A.menu_seq = 1 ";
if(pRegion >= 1 && pRegion <= 6){
	strWhere += "AND A.region_seq = " + pRegion;
}

String strWhere2 = "AND C.site_seq = 1 AND C.menu_seq = 2 AND A.menu_seq = 2 ";
if(pRegion >= 1 && pRegion <= 6){
