                    ...
                    <tr>
                        <td style="background-image:url('./img/boxbg551.gif') ;">
                            ...
                            <p class="align_left">결제된 건에 대한 매입을 요청하는 페이지 입니다. <br/>
                                이 페이지는 KCP에 <span class="red">수동매입</span> 가맹점으로 등록된 경우에만 사용합니다.<br/>
                                <span class="red">수동매입</span> 가맹점인 경우에만 사용하시기 바랍니다.
                            </p>
                            <p class="align_left">
                        ...
                        <td>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <input type="image" src="./img/btn_buy.gif" onclick="return jsf__go_mod(this.form);" style="width:108px;height:37px" alt="매입을 요청합니다" />
