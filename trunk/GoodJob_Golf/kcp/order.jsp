...
<script type="text/javascript">
        ...
        function  jsf__pay( form )
        {
            ...
            {
                openwin = window.open( "/sample/chk_plugin.html", "chk_plugin", "width=420, height=100, top=300, left=300" );
            }

            /* Payplus Plugin 실행 */
            if ( MakePayMessage( form ) == true )
            {
                openwin = window.open( "/sample/proc_win.html", "proc_win", "width=449, height=209, top=300, left=300" );
                RetVal = true ;
            }
            else
            {
        ...
        function init_orderid()
        {
            ...
            var order_idxx = "GJGF" + year + "" + month + "" + date + "" + time;
