...
<TD colspan="5">
	...
	<TD style="PADDING-LEFT: 10px" bgColor=white colSpan=3><INPUT class=mem_input id="email1" name="email1" size=15 value="<%=eMail1 %>"> @ <INPUT class=mem_input ID="email2" name="email2" size=15 value="<%=eMail2 %>"> 
