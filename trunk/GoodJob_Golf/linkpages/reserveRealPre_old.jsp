...
<table border="0" cellpadding="0" cellspacing="0" width="707" align="center">
    <tr>
        <td width="707">
           <img src="../images/img_nh_golf/img_visual_golf.jpg" width="707" height="276" border="0">
        </td>
    </tr>
</table>
<TABLE border=0 cellSpacing=1 cellPadding=2 width=751 height="650">
<TBODY>
<TR>
<TD bgColor=white vAlign=top width=745 align=center>
	...
	<TD vAlign=top>
		...
		<TD align=center>
			...
			<TBODY>
			<TR>
			<TD bgColor=#f1f1f1 height=35 align=center><SPAN class=normal_b>실시간예약 골프장명</SPAN></TD>
			<% 
			for (int i = 1; i < 15 ;i++){
		...
		<TD align=center>
			...
			<TBODY>
			<TR>
			<TD bgColor=#f1f1f1 height=35 align=center><SPAN class=normal_b>사전신청예약 골프장명</SPAN></TD>
			<% 
