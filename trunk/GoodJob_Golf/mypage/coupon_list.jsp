...
<%
	...
	//골프장
	List<CouponDto> ingList = myDao.getMyCouponList(params);
                                                          ...
                                                          <td align="center">
                                                              ...
                                                              <tr>
                                                                <td width="426"><table border="0" cellpadding="0" cellspacing="0" width="704">
                                                                    <tr>
                                                                      <td onClick="DisplayMenu(1)" style="cursor:hand" width="176"><img src="/images/mypage/btn_tab_on_coupon_01.gif" width="173" height="25" alt="사용가능한 상품권"></td>
                                                                      <td onClick="DisplayMenu(2)" style="cursor:hand" width="176"><img src="/images/mypage/btn_tab_off_coupon_02.gif" width="173" height="25" alt="과거 상품권 내역"></td>
                                                                      <td onClick="DisplayMenu(3)" style="cursor:hand" width="176">&nbsp;</td>
                                                                      <td onClick="DisplayMenu(4)" style="cursor:hand" width="176">&nbsp;</td>
                                                                    </tr>
                                                                    <tr>
