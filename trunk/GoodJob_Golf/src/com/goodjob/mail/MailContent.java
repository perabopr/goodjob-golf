...
public class MailContent {
	...
	public static String pwChange(){
		...
		builder.append("<TBODY>\n");
		builder.append("<TR>\n");
		builder.append("<TD height=300 width=650>\n");
		builder.append("<P><SPAN style=\"FONT-SIZE: 9pt\" class=normal></SPAN>&nbsp;</P>\n");
		builder.append("<P><SPAN style=\"FONT-FAMILY: 돋움,dotum; FONT-SIZE: 9pt\" class=normal>안녕하세요, 회원님<BR>고객님의 비밀번호가 변경되었음을 알려드립니다. 만약 도용에 의한 비밀번호 변경인 경우 고객센터로 즉시 문의하여 <BR>주시기 바랍니다.</SPAN><BR><BR>\n");
		builder.append("<SPAN style=\"FONT-FAMILY: 돋움,dotum; FONT-SIZE: 9pt\" class=normal>아이디 : </SPAN><SPAN class=orange><STRONG><FONT color=#f96f0a>\n");
		...
		builder.append("<SPAN style=\"FONT-FAMILY: 돋움,dotum; FONT-SIZE: 9pt\" class=normal>비밀번호 변경일 : {1} <BR><BR></SPAN>\n");
		builder.append("<SPAN style=\"FONT-FAMILY: 돋움,dotum; FONT-SIZE: 9pt\" class=normal>앞으로 고객님께 더욱 만족스러운 서비스와 커다란 즐거움을 제공할 수 있도록 항상 노력하는 Goodjobgolf가 <BR>되겠습니다.<BR>감사합니다. </SPAN><BR><BR><STRONG><SPAN class=normal_b><SPAN style=\"FONT-FAMILY: 돋움,dotum; FONT-SIZE: 9pt\">Goodjobgolf 전화상담 이용안내</SPAN></SPAN><SPAN style=\"FONT-FAMILY: 돋움,dotum; FONT-SIZE: 9pt\"> </SPAN><BR><BR></STRONG><SPAN style=\"FONT-FAMILY: 돋움,dotum; FONT-SIZE: 9pt\" class=normal>고객센터 : 02-6670-0202<BR>상담시간 : 평일 09:00 ~ 18:00 , 토요일 09:00 ~ 12:00 <BR>E-mail : webmaster@goodjobgolf.com</SPAN><SPAN style=\"FONT-FAMILY: 돋움,dotum\">&nbsp;</SPAN></P></TD></TR></TBODY></TABLE></TD></TR>\n");
		builder.append("<TR>\n");
