...
public class MEMBER {
	...
	//회원 리스트
	public static final String list = " select mem_no,mem_id,mem_name,mem_pwd,mem_jumin,mem_mtel,sms_yn,email_yn,"+
	"mem_type,reg_dt from tb_member where SECESSION = 'N' %s order by mem_no desc limit ? , ? ";
