...
public final class pop_005fcourse_005fdel_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String glSeq = request.getParameter("glSeq2");
String courseSeq = request.getParameter("courseSeq");

GolfLinkDao gfdao = new GolfLinkDao();
gfdao.setGolfLinkCourseDelete(Integer.parseInt(courseSeq));
